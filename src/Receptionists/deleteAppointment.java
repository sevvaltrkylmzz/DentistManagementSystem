...
public class deleteAppointment extends javax.swing.JFrame {
    ...
    public deleteAppointment() {
        ...
        Object columns[] = {"AID", "AType", "DID", "AStatus", "ADate", "ATime"};
    ...
    public void loadData() {
        ...
        String sql = "select AID,AType,DID,AStatus,ADate,ATime from appointment";
        try {
            ps = connection.prepareStatement(sql);
            rs = ps.executeQuery();
            Object columnData[] = new Object[12];
            while (rs.next()) {
                 columnData[0] = rs.getInt("AID");
                columnData[1] = rs.getString("AType");
                columnData[2] = rs.getString("DID");
                columnData[3] = rs.getString("AStatus");
                columnData[4] = rs.getString("ADate");
                columnData[5] = rs.getString("ATime");
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Delete Appointment");
        ...
        jLabel1.setText("ID of the Appointment");
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        String sql = "Delete from appointment where AID ='" + search + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
