...
/**
 *
 * @author package Patient;

import Treatment.updatePatient;
import Treatment.treatmentActivity;
import Main.Connector;
import Main.Hospital;
import java.awt.HeadlessException;
import java.sql.Connection;
...
public class updatePatient extends javax.swing.JFrame {
   ...
   /* int count;
    ...
    public updatePatient() {
        ...
        Object columns[] = {"PID", "FName", "MInit", "LName", "Gender", "BirthDate", "Email", "Address"};
    ...
    public void loadData() {
        ...
        String sql = "select PID,FName,MInit,LName,Gender,BirthDate,EMail,Address from patient";
        try {
            ...
            while (rs.next()) {
                ...
                columnData[5] = rs.getString("BirthDate");
    ...
    private void pUTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pUTableMouseClicked
        ...
        String pfname = (pUTable.getValueAt(row, 1).toString());
        String pmname = (pUTable.getValueAt(row, 2).toString());
        String plname = (pUTable.getValueAt(row, 3).toString());
        String pgender = (pUTable.getValueAt(row, 4).toString());
        String pbirthdate = (pUTable.getValueAt(row, 5).toString());
        String pemail = (pUTable.getValueAt(row, 6).toString());
        String paddress = (pUTable.getValueAt(row, 7).toString());
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update patient set FName = '" + fname + "', MInit = '" + mname + "', LName = '" + lname + "', Gender = '" + gender + "', BirthDate = '" + birthdate + "', EMail = '" + email + "', Address = '" + address + "' where PID = '" + id + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
