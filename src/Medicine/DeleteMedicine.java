...
import Treatment.DeleteTreatment;
...
import Treatment.DeletePatient;
import Main.Connector;
import Main.Hospital;
import java.sql.Connection;
import java.sql.PreparedStatement;
...
public class DeleteMedicine extends javax.swing.JFrame {
    ...
    public DeleteMedicine() {
        ...
        Object columns[] = {"MID", "MType", "Mname","TID"};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ID of Medicine");
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        String sql = "Delete from medicine where MID ='" + search + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            ...
            JOptionPane.showMessageDialog(null, "medicine id: " + search + " not found");
        }
