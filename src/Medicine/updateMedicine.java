...
/**
 *
 * @authorpackage Medicine;

import Treatment.updatePatient;
import Treatment.patientActivity;
import Main.Connector;
import Main.Hospital;
import java.awt.HeadlessException;
import java.sql.Connection;
...
public class updateMedicine extends javax.swing.JFrame {
   ...
   /* int count;
    ...
    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        medicineActivity paActivity = new  medicineActivity();
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update patient set FName = '" + fname + "', MInit = '" + mname + "', LName = '" + lname + "', Gender = '" + gender + "', BirthDate = '" ;
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
