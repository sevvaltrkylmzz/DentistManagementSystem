 ...
 * @author Sajeeb
 */
public class medicineActivity extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Medicine Panel");
        ...
        jLabel3.setText("Medicine Panel");
        ...
        jLabel4.setText("Update Medicine");
        ...
        jLabel13.setText("View Medicine");
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
       addMedicine adp = new addMedicine();
        adp.setVisible(true);
        dispose();
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
       viewMedicine vPatient = new viewMedicine();
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        DeleteMedicine deletePatient = new DeleteMedicine();
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        updateMedicine uPatient = new updateMedicine();
    ...
    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
       searchMedicine sPatient = new searchMedicine();
    ...
    public static void main(String args[]) {
       java.awt.EventQueue.invokeLater(() -> {
            new medicineActivity().setVisible(true);
        });
    }
