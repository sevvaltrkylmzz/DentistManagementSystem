...
import Treatment.viewTreatment;
...
public class viewMedicine extends javax.swing.JFrame {
   ...
   Connection connection = null;
    ...
    public void loadData() {
        ...
        String sql = "select MID,MType,MName,TID from medicine";
        try {
            ps = connection.prepareStatement(sql);
            rs = ps.executeQuery();
            Object columnData[] = new Object[11];
            while (rs.next()) {
                columnData[0] = rs.getInt("MID");
                columnData[1] = rs.getString("MType");
                columnData[2] = rs.getString("MName");
                columnData[3] = rs.getString("TID");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 35, -1, -1));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 111, 1260, 473));
