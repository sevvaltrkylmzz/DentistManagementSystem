 ...
 * @author Sajeeb
 */
public class DeleteTreatment extends javax.swing.JFrame {
    ...
    public DeleteTreatment() {
        ...
        Object columns[] = {"TID", "TOperation", "TBill"};
    ...
    public void loadData() {
        ...
        String sql = "select TID,TOperation,TBill from treatment";
        try {
            ...
            while (rs.next()) {
                ...
                columnData[1] = rs.getString("TOperation");
                columnData[2] = rs.getString("TBill");
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Delete Treatment");
        ...
        jLabel1.setText("ID of Treatment");
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        String sql = "Delete from treatment where TID ='" + search + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            JOptionPane.showMessageDialog(null, "Treatment " + search + " has been deleted");
            defaultTableModel.getDataVector().removeAllElements();
            defaultTableModel.fireTableDataChanged();
            loadData();
            connection.close();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "treatment id: " + search + " not found");
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new DeleteTreatment().setVisible(true);
        });
    }
