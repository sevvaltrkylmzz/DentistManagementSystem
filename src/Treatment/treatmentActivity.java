 ...
 * @author Sajeeb
 */
public class treatmentActivity extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabeltadd = new javax.swing.JLabel();
        ...
        jLabel10.setText("Treatment Panel");
        ...
        jLabel3.setText("Treatment Panel");
        ...
        jLabel4.setText("Update Treatment");
        ...
        jLabeltadd.setFont(new java.awt.Font("Arial", 0, 22)); // NOI18N
        jLabeltadd.setForeground(new java.awt.Color(255, 255, 255));
        jLabeltadd.setText("Add Treatment");
        jLabeltadd.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabeltaddMouseClicked(evt);
            }
        });
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabeltadd, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jLabel8.setText("Delete Treatment");
        ...
        jLabel11.setText("Search Treatment");
        ...
        jLabel13.setText("View Treatment");
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        addTreatment adp = new addTreatment();
        adp.setVisible(true);
        dispose();
    }//GEN-LAST:event_jLabel7MouseClicked

    private void jLabeltaddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabeltaddMouseClicked
        addTreatment adp = new addTreatment();
        adp.setVisible(true);
        dispose();
    }//GEN-LAST:event_jLabeltaddMouseClicked

    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        viewTreatment vPatient = new viewTreatment();
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        DeleteTreatment deletePatient = new DeleteTreatment();
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        updateTreatment uPatient = new updateTreatment();
    ...
    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
        searchTreatment sPatient = new searchTreatment();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new treatmentActivity().setVisible(true);
        });
    }
    ...
    private javax.swing.JLabel jLabeltadd;
